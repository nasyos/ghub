...
export const MOCK_THREADS: MockThread[] = [
  // GH Japan threads (Connected)
  {
    ...
    ownerCA: "佐藤",
    title: "Nguyen Thi A",
    lastMessageAt: "2025-08-15T14:30:00Z",
    unread: true,
    recentTag: "初回連絡",
    sendability: "active",
  },
  {
    ...
    ownerCA: "田中",
    title: "Kumar Raj",
    lastMessageAt: "2025-08-15T13:15:00Z",
    unread: false,
    recentTag: "書類確認",
  ...
  },
  {
    ...
    ownerCA: "山田",
    title: "Li Wei",
    lastMessageAt: "2025-08-15T12:45:00Z",
    unread: true,
    recentTag: "初回面談",
  ...
  },
  {
    ...
    ownerCA: "佐藤",
    title: "Patel Arjun",
    lastMessageAt: "2025-08-15T11:20:00Z",
    unread: false,
    recentTag: "内定通知",
    sendability: "blocked",
  },
  {
    ...
    ownerCA: "鈴木",
    title: "Wang Lei",
    lastMessageAt: "2025-08-15T13:45:00Z",
    unread: false,
    recentTag: "面接調整",
    sendability: "active",
  },
  ...
  // GH Asia threads (Expiring7)
  {
    ...
    ownerCA: "佐藤",
    title: "Patel Arjun",
    lastMessageAt: "2025-08-15T10:30:00Z",
    unread: true,
    recentTag: "書類依頼",
    sendability: "human_agent",
  },
  {
    ...
    lastMessageAt: "2025-08-15T09:15:00Z",
    unread: false,
    recentTag: "初回連絡",
    sendability: "requires_tag",
  },
  {
    ...
    ownerCA: "田中",
    title: "Chen Xiao",
    lastMessageAt: "2025-08-14T16:45:00Z",
    unread: true,
    recentTag: "面接調整",
    sendability: "human_agent",
  },
...
export const MOCK_MESSAGES: MockMessage[] = [
  ...
  // GH Japan Thread 5 - Wang Lei (王磊) - 10往復のサンプルメッセージ
  {
    id: "msg-gh-jp-5-1",
    threadId: "thread-gh-jp-5",
    direction: "in",
    bodyOriginal: "你好！我想了解更多关于这个职位的信息。工作地点在哪里？",
    bodyTranslated: "こんにちは！この職位について詳しく知りたいです。勤務地はどこですか？",
    lang: "zh",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "out",
    bodyOriginal: "你好！工作地点在东京都涩谷区。也可以远程工作。还有其他问题吗？",
    bodyTranslated: "こんにちは！勤務地は東京都渋谷区です。リモートワークも可能です。他にご質問はありますか？",
    lang: "ja",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "in",
    bodyOriginal: "谢谢！我想知道工作时间是怎样的？有加班吗？",
    bodyTranslated: "ありがとうございます！勤務時間はどのようになっていますか？残業はありますか？",
    lang: "zh",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "out",
    bodyOriginal: "工作时间是9:00-18:00，基本没有加班。请问您有餐饮行业的工作经验吗？",
    bodyTranslated: "勤務時間は9:00-18:00で、基本的に残業はありません。飲食業界でのお仕事経験はおありですか？",
    lang: "ja",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "in",
    bodyOriginal: "我在中国有3年的餐厅工作经验。工资大概是多少？",
    bodyTranslated: "中国で3年間のレストランでの勤務経験があります。給料はどのくらいですか？",
    lang: "zh",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "out",
    bodyOriginal: "月薪25-30万日元，根据经验调整。您什么时候可以开始工作？",
    bodyTranslated: "月給25-30万円で、経験に応じて調整いたします。いつからお仕事を始められますか？",
    lang: "ja",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "in",
    bodyOriginal: "我下个月就可以开始。需要什么证件吗？",
    bodyTranslated: "来月から始められます。必要な書類はありますか？",
    lang: "zh",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "out",
    bodyOriginal: "需要简历、护照复印件和健康证明。我们可以安排面试吗？",
    bodyTranslated: "履歴書、パスポートのコピー、健康診断書が必要です。面接の調整は可能でしょうか？",
    lang: "ja",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "in",
    bodyOriginal: "好的！我什么时候可以面试？可以视频面试吗？",
    bodyTranslated: "はい！いつ面接できますか？ビデオ面接は可能ですか？",
    lang: "zh",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "out",
    bodyOriginal: "当然可以！明天下午2点怎么样？我会发送Zoom链接给您。",
    bodyTranslated: "もちろん可能です！明日の午後2時はいかがでしょうか？Zoomのリンクをお送りいたします。",
    lang: "ja",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "in",
    bodyOriginal: "太好了！明天见。谢谢您的帮助！",
    bodyTranslated: "素晴らしいです！明日お会いしましょう。ご協力ありがとうございます！",
    lang: "zh",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "out",
    bodyOriginal: "不客气！期待明天与您见面。请准备好您的简历。",
    bodyTranslated: "どういたしまして！明日お会いできることを楽しみにしています。履歴書をご準備ください。",
    lang: "ja",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "in",
    bodyOriginal: "我已经准备好了。请问面试大概需要多长时间？",
    bodyTranslated: "もう準備できています。面接はどのくらいの時間がかかりますか？",
    lang: "zh",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "out",
    bodyOriginal: "大约30-45分钟。我们会讨论您的工作经验和公司文化。",
    bodyTranslated: "約30-45分です。お仕事経験と会社の文化についてお話しします。",
    lang: "ja",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "in",
    bodyOriginal: "明白了。我会准时参加的。还有其他需要准备的吗？",
    bodyTranslated: "分かりました。時間通りに参加いたします。他に準備が必要なものはありますか？",
    lang: "zh",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "out",
    bodyOriginal: "没有其他了。请确保网络连接良好。明天见！",
    bodyTranslated: "他にはありません。ネットワーク接続が良好であることをご確認ください。明日お会いしましょう！",
    lang: "ja",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "in",
    bodyOriginal: "好的，明天见！谢谢！",
    bodyTranslated: "はい、明日お会いしましょう！ありがとうございます！",
    lang: "zh",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "out",
    bodyOriginal: "不客气！祝您面试顺利！",
    bodyTranslated: "どういたしまして！面接がうまくいきますように！",
    lang: "ja",
    createdAt: "2025-08-15T13:15:00Z",
  },
  {
    id: "msg-gh-jp-5-19",
    threadId: "thread-gh-jp-5",
    direction: "in",
    bodyOriginal: "谢谢！我会努力的！",
    bodyTranslated: "ありがとうございます！頑張ります！",
    lang: "zh",
  ...
  },
  {
    ...
    threadId: "thread-gh-jp-5",
    direction: "out",
    bodyOriginal: "很好！我们明天见。如果有什么问题，随时联系我。",
    bodyTranslated: "素晴らしいです！明日お会いしましょう。何かご質問があれば、いつでもお気軽にお声かけください。",
    lang: "ja",
  ...
  // Active examples (no tags needed)
  {
    ...
    direction: "in",
    bodyOriginal: "你好！我想了解更多关于这个职位的信息。工作地点在哪里？",
    bodyTranslated: "こんにちは！この職位についてもっと詳しく知りたいです。勤務地はどこですか？",
    lang: "zh",
  ...
  },
  {
    ...
    direction: "out",
    bodyOriginal: "你好！工作地点在东京都涩谷区。也可以远程工作。还有其他问题吗？",
    bodyTranslated: "こんにちは！勤務地は東京都渋谷区です。リモートワークも可能です。他にご質問はございますか？",
    lang: "zh",
...

  {
    ...
    bodyTranslated: "こんにちは！あなたのウェブサイトを通じて応募しました。いつ頃返事をいただけますか？",
    lang: "en",
...
export const MOCK_CANDIDATES = [
  ...
  },
  {
    ...
    desiredJobType: "飲食",
    desiredWorkLocation: "東京",
    candidateStatus: "面接調整",
    assignedCA: "鈴木",
    email: "wang.lei@example.com",
    phone: "080-5678-9012",
    experience: "3年",
    skills: ["レストラン運営", "顧客サービス", "チームマネジメント"],
    japaneseLevel: "N3",
    visaStatus: "技術・人文知識・国際業務",
    facebookProfile: "https://facebook.com/wang.lei",
  },
]
